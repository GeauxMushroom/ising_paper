...
\title{Three Dimensional Edwards-Anderson Spin Glass Model in an External Field}% Force line breaks with \\
...
\affiliation{%
ECE Division, School of Electrical Engineering and Computer Science, Louisiana State University, Baton Rouge, LA 70803, USA
}
\author{Ka-Ming~Tam}
\affiliation{%
 Department of Physics and Astronomy, Louisiana State University, Baton Rouge, LA 70803, USA
...
\affiliation{%
Center for Advanced Computing and Data Systems, University of Houston, Houston, TX 77204, USA}
...
phase transition. We find that this new indicator is fairly noisy, so 
...
is beyond the reach of the present data. This reveals the difficulty with 
current numerical methods and computing capability
in studying this problem.
%This calls for a more thorough study 
%of the three dimensional Edwards-Anderson model in an external field. 
...
\pacs{64.70.qj,75.10.Nr,75.10.Hk}% PACS, the Physics and Astronomy
...
Ref \onlinecite{Fang-Feng-Tam-etal-2013}. 
...
\begin{figure}[ht]
  \includegraphics[width=0.45\textwidth]{img/binder.pdf}% Here is how to import EPS art
...
\begin{figure}[ht]
  \includegraphics[width=0.45\textwidth]{img/corr.pdf}% Here is how to import EPS art
...
\begin{figure}[ht]
\includegraphics[width=0.45\textwidth]{img/r12.pdf}% Here is how to import EPS art
...
perdominately due to the distance away from the known critical point at $h=0$. 
...
results obtainable in a reasonable amount of time and resoucce are still not robust enough 
to provide dispositive insight into the nature of a spin glass at three dimensions. This makes a call 
to the method of interpretating the data. We propose that a possible direction for the 
