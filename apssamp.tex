...
the transition exist at h=0.25, it would likely be at quite a bit lower temperature
...
the best for the purpose of answering the question on the existence of the transition under an 
external magnetic field. But we believe that the possible advantage of using h=0.25 does
not outweigh the advantage of using h=0.1, both in term of the difficult of the simulation, and
the predictive power. Therefore, we think using h=0.1 is appropriate  
