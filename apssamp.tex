...
is beyond the reach of the present data. This calls for a more thorough study 
...
using the present method are daunting.  We show that the distribution of 
susceptibilities are not normally distributed, and calculate ratio of susceptibilities
from the geometrical average, but we can not reach a definitive conclusion.
